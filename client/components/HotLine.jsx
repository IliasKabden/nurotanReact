...
export default class HotLine extends Component {
  render() {
    const {currentHotLine, mpStrings, lang} = this.props;
        ...
        <div id="main" className="hot-line-page">
          ...
          <div id="theme-blog" className="theme-search city center">
            <div className="left-theme">
              <h1 className="city">{mpStrings.hotLine.toUpperCase()}</h1>
            </div>
          ...
          <div id="main-video" className="center">
            <div className="content-news">
              <div id="blocks-news" className="cell-8">
                <div dangerouslySetInnerHTML={{__html: currentHotLine[lang]}}/>
              </div>
              <div id="blog" className="cell-4">
                <div className="cell-12">
                  {this.props.hotLineFilesJSX}
