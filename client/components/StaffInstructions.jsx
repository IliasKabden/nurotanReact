...
export default class StaffInstructions extends Component {
  render() {
        ...
        <div id="main" className="all-video-page">
          <div id="theme-blog" className="theme-search city center">
            <div className="left-theme">
              <h1 className="paper">{mpStrings.staffInstructions.toUpperCase()}</h1>
            </div>
          ...
          <div className="center">
            <h2 className="green">{mpStrings.staffInstructions.toUpperCase()}</h2>
