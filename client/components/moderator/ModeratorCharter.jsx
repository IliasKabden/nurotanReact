...
export default class ModeratorCharter extends Component {
  componentDidMount() {
    $.getScript('/custom/plugins/ckeditor/ckeditor.js', () => {
      CKEDITOR.replace('charterru', {
        height: 700,
        contentsCss : '/custom/css/style.css'
      });
      CKEDITOR.replace('charterkz', {
        height: 700,
        contentsCss : '/custom/css/style.css'
      });
  ...
  setEditorValues() {
    ...
    setEditorValue('charterru', currentCharter.ru);
    setEditorValue('charterkz', currentCharter.kz);
  }
            ...
            <div className="col-sm-12">
              <div className="box box-primary">
                <div className="box-header with-border">
                  <h3 className="box-title">Редактирование Устава партии</h3>
                </div>
                {/* /.box-header */}
                {/* form start */}
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane active" id="tab-russian">
                          <div className="form-group">
                            <label>Устав партии</label>
                            <textarea id="charterru" name="leadership-ru" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
                        ...
                        <div className="tab-pane" id="tab-kazakh">
                          <div className="form-group">
                            <label>Устав партии</label>
                            <textarea id="charterkz" name="leadership-kz" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
