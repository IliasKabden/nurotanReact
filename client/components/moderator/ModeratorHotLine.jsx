...
export default class ModeratorHotLine extends Component {
  componentDidMount() {
    $.getScript('/custom/plugins/ckeditor/ckeditor.js', () => {
      CKEDITOR.replace('hotLineru', {
        height: 700,
        contentsCss : '/custom/css/style.css'
      });
      CKEDITOR.replace('hotLinekz', {
        height: 700,
        contentsCss : '/custom/css/style.css'
      });
  ...
  setEditorValues() {
    ...
    setEditorValue('hotLineru', currentHotLine.ru);
    setEditorValue('hotLinekz', currentHotLine.kz);
  }
            ...
            <div className="col-sm-12">
              <div className="box box-primary">
                <div className="box-header with-border">
                  <h3 className="box-title">Редактирование Горячей линии</h3>
                </div>
                {/* /.box-header */}
                {/* form start */}
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane active" id="tab-russian">
                          <div className="form-group">
                            ...
                            <textarea id="hotLineru" name="leadership-ru" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
                        ...
                        <div className="tab-pane" id="tab-kazakh">
                          <div className="form-group">
                            <label>Горячая линия</label>
                            <textarea id="hotLinekz" name="leadership-kz" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
