...
export default class ModeratorStaffInstructions extends Component {

  render() {
    const {editStaffInstructionsButtonHandler, removeStaffInstructionsButtonHandler} = this.props;
        ...
        <div className="container">
          <section className="content-header">
            <h1>
              ...
              Инструкция по формированию республиканского партийного кадрового резерва
              <small>словарь</small>
            </h1>
              ...
              <div className="col-sm-12">
                <div className="box box-primary">
                  <div className="box-header with-border">
                    <h3 className="box-title">Добавление новой кадрового резерва -  Инструкция по формированию республиканского партийного кадрового резерва</h3>
                  </div>
                  {/* /.box-header */}
                  {/* form start */}
                  <form id="moderator-staffInstructions-form" role="form">
                          ...
                          <div id="tab-general" className="tab-pane active">
                            <div className="mailbox-controls">
                              <div className="btn-group">
                                ...
                                <button onClick={removeStaffInstructionsButtonHandler} type="button" className="btn btn-default btn-sm">
                                  <i className="fa fa-trash-o" />
                                </button>
                                <button onClick={editStaffInstructionsButtonHandler} type="button" className="btn btn-default btn-sm">
                            ...
                            <div className="table-responsive">
                              <table className="table table-bordered">
                                <tbody>
                                  ...
                                  {this.props.staffInstructionsJSX}
                                </tbody>
                              </table>
                            </div>
                            <div className="mailbox-controls">
                    ...
                    <div className="box-footer">
                      <button onClick={this.props.addStaffInstructionsButtonHandler} type="submit" className="btn btn-primary">Добавить кадровый резерв</button>
                    </div>
                  </form>
                </div>
              </div>
          ...
          <div className="modal fade" id="staffInstructions-edit-modal" tabIndex={-1} role="dialog" aria-labelledby="myModalLabel">
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <button type="button" className="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                  <h4 className="modal-title" id="myModalLabel">Редактирование кадрового резерва - РЕЗЕРВИСТОВ БЛИЖАЙШЕГО И СРЕДНЕСРОЧНОГО УРОВНЕЙ /</h4>
                </div>
                <div className="modal-body">
                  <form id="modal-staffInstructions-form" role="form">
                    <div className="col-xs-12">
                      {/* Custom Tabs */}
                      <div className="nav-tabs-custom">
                        <ul className="nav nav-tabs">
