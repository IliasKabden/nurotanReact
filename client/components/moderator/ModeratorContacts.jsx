...
export default class ModeratorContacts extends Component {
  componentDidMount() {
  ...
  setEditorValues() {
    const {currentContacts} = this.props;

    setEditorValue('contactsru', currentContacts.ru);
    setEditorValue('contactskz', currentContacts.kz);
  }
            ...
            <div className="col-sm-12">
              <div className="box box-primary">
                <div className="box-header with-border">
                  <h3 className="box-title">Редактирование Контактов</h3>
                </div>
                {/* /.box-header */}
                {/* form start */}
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane active" id="tab-russian">
                          <div className="form-group">
                            ...
                            <textarea id="contactsru" name="leadership-ru" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
                        ...
                        <div className="tab-pane" id="tab-kazakh">
                          <div className="form-group">
                            <label>Контакты</label>
                            <textarea id="contactskz" name="leadership-kz" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
