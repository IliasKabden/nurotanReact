...
export default class ModeratorPurchase extends Component {
  componentDidMount() {
    ...
    return (
      <div className="container">
        <section className="content-header">
          <h1>
            Страница добавления и редактирования закупок
            <small>словарь</small>
          </h1>
            ...
            <div className="col-sm-12">
              <div className="box box-primary">
                <div className="box-header with-border">
                  <h3 className="box-title">Добавление новой закупки</h3>
                </div>
                {/* /.box-header */}
                {/* form start */}
                <form id="moderator-purchase-form" role="form">
                    ...
                    <div className="nav-tabs-custom">
                      ...
                      <div className="tab-content">
                        <div className="tab-pane active" id="tab-table">
                          <div className="box box-primary">
                            <div className="box-header with-border">
                              <h3 className="box-title">Таблица закупок</h3>
                            ...
                            <div className="box-body no-padding">
                              <div className="mailbox-controls">
                                ...
                                <div className="btn-group">
                                  <button onClick={this.props.removePurchaseButtonHandler} type="button" className="btn btn-default btn-sm"><i className="fa fa-trash-o" /></button>
                                  <button onClick={this.props.editPurchaseButtonHandler} type="button" className="btn btn-default btn-sm"><i className="fa fa-edit" /></button>
                                </div>
                                {/* /.btn-group */}
                                {/* /.pull-right */}
                              </div>
                        ...
                        <div className="tab-pane" id="tab-russian">
                          ...
                          <div className="form-group">
                            ...
                            <input name="purchase-title-ru" placeholder="Введите название закупки" className="form-control"/>
                          </div>
                          <div className="form-group">
                            <label>Текст закупки</label>
                            <textarea id="textEditorRu" placeholder="Введите текст закупки" className="form-control" rows={16} defaultValue={""} />
                          </div>
                          <div className="form-group">
                        ...
                        <div className="tab-pane" id="tab-kazakh">
                          ...
                          <div className="form-group">
                            <label>Название закупки</label>
                            <input name="purchase-title-kz" placeholder="Введите название закупки" className="form-control"/>
                          </div>
                          <div className="form-group">
                            <label>Текст закупки</label>
                            <textarea id="textEditorKz" placeholder="Введите текст закупки" className="form-control" rows={16} defaultValue={""} />
                          </div>
                          <div className="form-group">
                  ...
                  <div className="box-footer">
                    <button onClick={this.props.addPurchaseButtonHandler} type="submit" className="btn btn-primary">Добавить закупку</button>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div className="modal fade" id="purchase-edit-modal" tabIndex={-1} role="dialog" aria-labelledby="myModalLabel">
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <button type="button" className="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 className="modal-title" id="myModalLabel">Редактирование закупки/</h4>
              </div>
              <div className="modal-body">
                <form id="modal-purchase-form" role="form">
                  <div className="col-xs-12">
                    {/* Custom Tabs */}
                    <div className="nav-tabs-custom">
                      <ul className="nav nav-tabs">
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane active" id="modal-tab-russian">
                          ...
                          <div className="form-group">
                            <label>Текст закупки</label>
                            <textarea id="modalTextEditorRu" placeholder="Введите текст закупки" className="form-control" rows={16} defaultValue={""} />
                          </div>
                          <div className="form-group">
                        ...
                        <div className="tab-pane" id="modal-tab-kazakh">
                          ...
                          <div className="form-group">
                            <label>Текст закупки</label>
                            <textarea id="modalTextEditorKz" placeholder="Введите текст закупки" className="form-control" rows={16} defaultValue={""} />
                          </div>
                          <div className="form-group">
