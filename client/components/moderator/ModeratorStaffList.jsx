...
export default class ModeratorStaffList extends Component {

  render() {
    const {editStaffListButtonHandler, removeStaffListButtonHandler} = this.props;
        ...
        <div className="container">
          <section className="content-header">
            <h1>
              ...
              СПИСКИ РЕЗЕРВИСТОВ БЛИЖАЙШЕГО И СРЕДНЕСРОЧНОГО УРОВНЕЙ
              <small>словарь</small>
            </h1>
              ...
              <div className="col-sm-12">
                <div className="box box-primary">
                  <div className="box-header with-border">
                    <h3 className="box-title">Добавление новой кадрового резерва -  РЕЗЕРВИСТОВ БЛИЖАЙШЕГО И СРЕДНЕСРОЧНОГО УРОВНЕЙ</h3>
                  </div>
                  {/* /.box-header */}
                  {/* form start */}
                  <form id="moderator-staffList-form" role="form">
                          ...
                          <div id="tab-general" className="tab-pane active">
                            <div className="mailbox-controls">
                              <div className="btn-group">
                                ...
                                <button onClick={removeStaffListButtonHandler} type="button" className="btn btn-default btn-sm">
                                  <i className="fa fa-trash-o" />
                                </button>
                                <button onClick={editStaffListButtonHandler} type="button" className="btn btn-default btn-sm">
                    ...
                    <div className="box-footer">
                      <button onClick={this.props.addStaffListButtonHandler} type="submit" className="btn btn-primary">Добавить кадровый резерв</button>
                    </div>
                  </form>
                </div>
              </div>
          ...
          <div className="modal fade" id="staffList-edit-modal" tabIndex={-1} role="dialog" aria-labelledby="myModalLabel">
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <form id="modal-staffList-form" role="form">
                    <div className="col-xs-12">
                      {/* Custom Tabs */}
                      <div className="nav-tabs-custom">
                        <ul className="nav nav-tabs">
