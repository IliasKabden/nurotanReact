...
export default class ModeratorCentralOffice extends Component {
  componentDidMount() {
    $.getScript('/custom/plugins/ckeditor/ckeditor.js', () => {
      CKEDITOR.replace('centralOfficeru', {
        height: 700,
        contentsCss : ['/custom/css/style.css', '/custom/css/main.css', '/custom/css/normalize.css']
      });
      CKEDITOR.replace('centralOfficekz', {
        height: 700,
        contentsCss : ['/custom/css/style.css', '/custom/css/main.css', '/custom/css/normalize.css']
      });
  ...
  setEditorValues() {
    const {currentCentralOffice} = this.props;

    setEditorValue('centralOfficeru', currentCentralOffice.ru);
    setEditorValue('centralOfficekz', currentCentralOffice.kz);
  }
            ...
            <div className="col-sm-12">
              <div className="box box-primary">
                <div className="box-header with-border">
                  <h3 className="box-title">Редактирование Центрального аппарата</h3>
                </div>
                {/* /.box-header */}
                {/* form start */}
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane active" id="tab-russian">
                          <div className="form-group">
                            <label>Центральный аппарат</label>
                            <textarea id="centralOfficeru" name="leadership-ru" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
                        ...
                        <div className="tab-pane" id="tab-kazakh">
                          <div className="form-group">
                            <label>Центральный аппарат</label>
                            <textarea id="centralOfficekz" name="leadership-kz" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
