...
export default class Fraction extends Component {
  componentDidMount() {
    $.getScript('/custom/plugins/ckeditor/ckeditor.js', () => {
      CKEDITOR.replace('fractionru', {
        height: 700,
        contentsCss : '/custom/css/style.css'
      });
      CKEDITOR.replace('fractionkz', {
        height: 700,
        contentsCss : '/custom/css/style.css'
      });
  ...
  setEditorValues() {
    const {currentFraction} = this.props,
          currentFractionPlaceholder = '<div><h2 class="green">ФРАКЦИЯ ПАРТИИИ «Нур Отан»</h2><img src="/custom/img/fraction.jpg" alt="ФРАКЦИЯ ПАРТИИИ «Нур Отан»" class="theme-bg w100"></div>';

    if(currentFraction) {
      setEditorValue('fractionru', currentFraction.ru);
      setEditorValue('fractionkz', currentFraction.kz);
    }
    else {
      setEditorValue('fractionru', currentFractionPlaceholder);
      setEditorValue('fractionkz', currentFractionPlaceholder);
    }
  }
            ...
            <div className="col-sm-12">
              <div className="box box-primary">
                <div className="box-header with-border">
                  <h3 className="box-title">Редактирование информации о фракции</h3>
                </div>
                {/* /.box-header */}
                {/* form start */}
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane active" id="tab-russian">
                          <div className="form-group">
                            <label>О фракции</label>
                            <textarea id="fractionru" name="leadership-ru" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
                        ...
                        <div className="tab-pane" id="tab-kazakh">
                          <div className="form-group">
                            <label>О фракции</label>
                            <textarea id="fractionkz" name="leadership-kz" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
