...
export default class ModeratorStaffReservist extends Component {

  render() {
    const {editStaffReservistButtonHandler, removeStaffReservistButtonHandler} = this.props;
        ...
        <div className="container">
          <section className="content-header">
            <h1>
              ...
              Список резервистов республиканского уровня
              <small>словарь</small>
            </h1>
              ...
              <div className="col-sm-12">
                <div className="box box-primary">
                  <div className="box-header with-border">
                    <h3 className="box-title">Добавление новой кадрового резерва -  Список резервистов республиканского уровня</h3>
                  </div>
                  {/* /.box-header */}
                  {/* form start */}
                  <form id="moderator-staffReservist-form" role="form">
                          ...
                          <div id="tab-general" className="tab-pane active">
                            <div className="mailbox-controls">
                              <div className="btn-group">
                                ...
                                <button onClick={removeStaffReservistButtonHandler} type="button" className="btn btn-default btn-sm">
                                  <i className="fa fa-trash-o" />
                                </button>
                                <button onClick={editStaffReservistButtonHandler} type="button" className="btn btn-default btn-sm">
                    ...
                    <div className="box-footer">
                      <button onClick={this.props.addStaffReservistButtonHandler} type="submit" className="btn btn-primary">Добавить кадровый резерв</button>
                    </div>
                  </form>
                </div>
              </div>
          ...
          <div className="modal fade" id="staffReservist-edit-modal" tabIndex={-1} role="dialog" aria-labelledby="myModalLabel">
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <form id="modal-staffReservist-form" role="form">
                    <div className="col-xs-12">
                      {/* Custom Tabs */}
                      <div className="nav-tabs-custom">
                        <ul className="nav nav-tabs">
