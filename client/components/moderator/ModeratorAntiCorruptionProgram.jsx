...
export default class ModeratorAntiCorruptionProgram extends Component {
  componentDidMount() {
    $.getScript('/custom/plugins/ckeditor/ckeditor.js', () => {
      CKEDITOR.replace('antiCorruptionProgramru', {
        height: 700,
        contentsCss : '/custom/css/style.css'
      });
      CKEDITOR.replace('antiCorruptionProgramkz', {
        height: 700,
        contentsCss : '/custom/css/style.css'
      });
  ...
  setEditorValues() {
    const {currentAntiCorruptionProgram} = this.props;

    setEditorValue('antiCorruptionProgramru', currentAntiCorruptionProgram.ru);
    setEditorValue('antiCorruptionProgramkz', currentAntiCorruptionProgram.kz);
  }
            ...
            <div className="col-sm-12">
              <div className="box box-primary">
                <div className="box-header with-border">
                  <h3 className="box-title">Редактирование Антикоррупционной программы</h3>
                </div>
                {/* /.box-header */}
                {/* form start */}
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane active" id="tab-russian">
                          <div className="form-group">
                            <label>Антикоррупционная компания</label>
                            <textarea id="antiCorruptionProgramru" name="leadership-ru" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
                        ...
                        <div className="tab-pane" id="tab-kazakh">
                          <div className="form-group">
                            <label>Антикоррупционная компания</label>
                            <textarea id="antiCorruptionProgramkz" name="leadership-kz" placeholder="..." className="form-control" rows={4} defaultValue={""} />
                          </div>
                          <div className="form-group">
