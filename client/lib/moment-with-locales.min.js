...
! function(a, b) {
    ...
    function V(a) {
        ...
        for (b = 0, c = d.length; b < c; b++) Be[d[b]] ? d[b] = Be[d[b]] : d[b] = U(d[b]);
        return function(b) {
            var e, f = "";
    ...
    function na() {
        ...
        for (
            ...
            d.sort(a), e.sort(a), f.sort(a), b = 0; b < 12; b++) d[b] = _(d[b]), e[b] = _(e[b]);
    ...
    function ua(a, b, c, d, e) {
        var f, g, h = (7 + c - d) % 7,
            i = ta(a, d, e),
            j = 1 + 7 * (b - 1) + h + i;
        return j <= 0 ? (f = a - 1, g = oa(f) + j) : j > oa(a) ? (f = a + 1, g = j - oa(a)) : (f = a, g = j), {
            year: f,
            dayOfYear: g
        }
    }
    ...
    function va(a, b, c) {
        ...
        return g < 1 ? (e = a.year() - 1, d = g + wa(e, b, c)) : g > wa(a.year(), b, c) ? (d = g - wa(a.year(), b, c), e = a.year() + 1) : (e = a.year(), d = g), {
            week: d,
            year: e
        }
    }
    ...
    function Pa() {
        ...
        for (
            ...
            // will match the longer piece.
            g.sort(a), h.sort(a), i.sort(a), k.sort(a), b = 0; b < 7; b++) h[b] = _(h[b]), i[b] = _(i[b]), k[b] = _(k[b]);
    ...
    function cb(a) {
        var b, c = a._a;
        return c && l(a).overflow === -2 && (b = c[We] < 0 || c[We] > 11 ? We : c[Xe] < 1 || c[Xe] > da(c[Ve], c[We]) ? Xe : c[Ye] < 0 || c[Ye] > 24 || 24 === c[Ye] && (0 !== c[Ze] || 0 !== c[$e] || 0 !== c[_e]) ? Ye : c[Ze] < 0 || c[Ze] > 59 ? Ze : c[$e] < 0 || c[$e] > 59 ? $e : c[_e] < 0 || c[_e] > 999 ? _e : -1, l(a)._overflowDayOfYear && (b < Ve || b > Xe) && (b = Xe), l(a)._overflowWeeks && b === -1 && (b = af), l(a)._overflowWeekday && b === -1 && (b = bf), l(a).overflow = b), a
    }
    ...
    function jb(b) {
        ...
        var c, d, e, f, g, h = "" + b._i,
            i = h.length,
            j = 0;
        for (e = X(b._f, b._locale).match(ye) || [], c = 0; c < e.length; c++) f = e[c], d = (h.match(Z(f, b)) || [])[0],
    ...
    function lb(a) {
        ...
        for (e = 0; e < a._f.length; e++) f = 0, b = p({}, a), null != a._useUTC && (b._useUTC = a._useUTC), b._f = a._f[e], jb(b), m(b) && (
    ...
    function Cb(b, c) {
        ...
        return this.isValid() ? null != b ? ("string" == typeof b ? b = zb(Qe, b) : Math.abs(b) < 16 && (b = 60 * b), !this._isUTC && c && (d = Bb(this)), this._offset = b, this._isUTC = !0, null != d && this.add(d, "m"), e !== b && (!c || this._changeInProgress ? Sb(this, Nb(b - e, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, a.updateOffset(this, !0), this._changeInProgress = null)), this) : this._isUTC ? e : Bb(this) : null != b ? this : NaN
    }
    ...
    function Gb() {
        if (this._tzm) this.utcOffset(this._tzm);
            ...
            var a = zb(Pe, this._i);
            0 === a ? this.utcOffset(0, !0) : this.utcOffset(zb(Pe, this._i))
        }
        return this
    }
    ...
    function Zb(a, b) {
        var c, d = r(a) ? a : rb(a);
        return !(!this.isValid() || !d.isValid()) && (b = J(b || "millisecond"), "millisecond" === b ? this.valueOf() === d.valueOf() : (c = d.valueOf(), this.clone().startOf(b).valueOf() <= c && c <= this.clone().endOf(b).valueOf()))
    }
    ...
    function hd(a, b, c) {
        var d = Nb(a).abs(),
            ...
            i = gg(d.as("M")),
            j = gg(d.as("y")),
            k = e < hg.s && ["s", e] || f <= 1 && ["m"] || f < hg.m && ["mm", f] || g <= 1 && ["h"] || g < hg.h && ["hh", g] || h <= 1 && ["d"] || h < hg.d && ["dd", h] || i <= 1 && ["M"] || i < hg.M && ["MM", i] || j <= 1 && ["y"] || ["yy", j];
    ...
    function de(a) {
        var b = Math.floor(a % 1e3 / 100),
            ...
            d = a % 10,
            e = "";
        return b > 0 && (e += xh[b] + "vatlh"), c > 0 && (e += ("" !== e ? " " : "") + xh[c] + "maH"), d > 0 && (e += ("" !== e ? " " : "") + xh[d]), "" === e ? "pagh" : e
    }
    ...
    pe = Array.prototype.indexOf ? Array.prototype.indexOf : function(a) {
        ...
        L("month", 8),
        // PARSING
        Y("M", He), Y("MM", He, De), Y("MMM", function(a, b) {
    ...
    Pf.add = Hf, Pf.calendar = Ub, Pf.clone = Vb, Pf.diff = ac, Pf.endOf = mc, Pf.format = ec, Pf.from = fc, Pf.fromNow = gc, Pf.to = hc, Pf.toNow = ic, Pf.get = Q, Pf.invalidAt = vc, Pf.isAfter = Wb, Pf.isBefore = Xb, Pf.isBetween = Yb, Pf.isSame = Zb, Pf.isSameOrAfter = $b, Pf.isSameOrBefore = _b, Pf.isValid = tc, Pf.lang = Jf, Pf.locale = jc, Pf.localeData = kc, Pf.max = Cf, Pf.min = Bf, Pf.parsingFlags = uc, Pf.set = R, Pf.startOf = lc, Pf.subtract = If, Pf.toArray = qc, Pf.toObject = rc, Pf.toDate = pc, Pf.toISOString = dc, Pf.toJSON = sc, Pf.toString = cc, Pf.unix = oc, Pf.valueOf = nc, Pf.creationData = wc,
        ...
        // Deprecations
        Pf.dates = w("dates accessor is deprecated. Use date instead.", Kf), Pf.months = w("months accessor is deprecated. Use month instead", ja), Pf.years = w("years accessor is deprecated. Use year instead", hf), Pf.zone = w("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", Db), Pf.isDSTShifted = w("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", Jb);
    var Qf = Pf,
        Rf = B.prototype;
    ...
    var kg = a,
        ...
        uh = (kg.defineLocale("sr-cyrl", {
            ...
            translate: function(a, b, c) {
                var d = uh.words[c];
                return 1 === c.length ? b ? d[0] : d[1] : a + " " + uh.correctGrammaticalCase(a, d)
            }
        }),
        ...
        kg.defineLocale('kz', {
          parentLocale: 'ru',
          months: ["Қаңтар", "Ақпан", "Наурыз", "Сәуір", "Мамыр", "Маусым", "Шілде",
          ...
          longDateFormat: {
              ...
              L: "DD.MM.YYYY",
              LL: "D MMMM YYYY ж.",
              LLL: "D MMMM YYYY ж., HH:mm",
              LLLL: "dddd, D MMMM YYYY ж., HH:mm"
          },
        }),
