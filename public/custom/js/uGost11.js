...
if (dmcookiescolor == 'color1') {
    document.write('<link type="text/css" rel="Stylesheet" href="/custom/css/ucoz/style2.css" />');

}
if (dmcookiescolor == 'color2') {
    document.write('<link type="text/css" rel="Stylesheet" href="/custom/css/ucoz/style1.css" />');
}
if (dmcookiescolor == 'color3') {
    document.write('<link type="text/css" rel="Stylesheet" href="/custom/css/ucoz/style3.css" />');
}
...
document.write('<link type="text/css" rel="Stylesheet" href="/custom/css/ucoz/allstyles.css" />');
